...
export  default class SquareImageCropper extends React.Component {
	...
	async _fetchRandomPhoto() {
		try {
			...
			if (randomPhoto) {
				//var randomPhoto={uri:'assets-library://asset/asset.JPG?id=4A8BDC47-7D84-4348-8A76-B273793672FA&ext=JPG',width:100,height:100,isShort:true}
